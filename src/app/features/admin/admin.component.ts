    ...
    <div class="min-h-screen bg-stone-100 font-sans flex flex-col">
      ...
      @if (!templeService.isAdmin()) {
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-stone-900/90 backdrop-blur-sm animate-fade-in">
          <div class="bg-white p-8 rounded-xl shadow-2xl text-center border-t-4 border-amber-600 w-full max-w-md">
             <div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span class="material-icons text-amber-700 text-3xl">lock</span>
             </div>
             ...
             <button (click)="attemptLogin()" class="bg-[#800000] text-white px-8 py-3 rounded-lg font-bold hover:bg-red-900 transition-colors w-full">Login</button>
          </div>
        </div>
      }
      ...
      <div class="flex flex-1 overflow-hidden h-screen">
        ...
        <aside class="w-64 bg-[#1a0a0a] text-amber-50 flex flex-col shadow-2xl z-20 border-r border-stone-800 flex-shrink-0">
          ...
          <nav class="flex-grow p-4 space-y-1 overflow-y-auto custom-scrollbar">
            <button (click)="setActiveTab('dashboard')" [class]="activeTab() === 'dashboard' ? 'bg-gradient-to-r from-[#800000] to-red-900 text-white shadow-md' : 'text-stone-400 hover:bg-stone-900 hover:text-amber-100'" class="w-full text-left px-4 py-3 rounded-lg flex gap-3 transition-all items-center text-sm font-medium mb-4">
        ...
        <main class="flex-grow p-8 overflow-y-auto bg-stone-100">
          ...
          @if (activeTab() === 'content-editor') {
             <div class="flex justify-between items-center mb-6">
               ...
               <button (click)="saveSettings()" class="bg-[#800000] text-white px-4 py-2 rounded text-sm font-bold flex items-center gap-2">
          ...
          @if (activeTab() === 'insights') {
             ...
             <div class="bg-white p-8 rounded-xl shadow-sm border border-stone-200 max-w-4xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                   ...
                   <button (click)="updateInsights()" class="mt-8 w-full bg-[#800000] hover:bg-red-900 text-white font-bold py-4 rounded-lg shadow-lg transition-all flex items-center justify-center gap-2">
          ...
          @if (activeTab() === 'settings') {
             <header class="mb-8 flex justify-between items-end">
               ...
               <button (click)="saveSettings()" class="bg-[#800000] text-white px-6 py-2 rounded font-bold hover:bg-red-900 transition-colors">Save Changes</button>
             </header>
        ...
        <div class="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fade-in p-4">
           <div class="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
              <div class="bg-stone-900 text-white p-4 flex justify-between items-center">
                 ...
                 <button (click)="showUserModal.set(false)" class="text-stone-400 hover:text-white"><span class="material-icons">close</span></button>
              </div>
