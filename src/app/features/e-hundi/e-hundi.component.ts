    ...
    <div class="bg-stone-50 min-h-screen py-12">
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden print:shadow-none print:max-w-full relative border border-stone-200">
          ...
          <!-- Secure Header -->
          <div class="bg-[#800000] text-white p-6 flex justify-between items-center relative z-20">
              ...
              @if (templeService.siteConfig().enableHundi) {
                ...
                @if (step() === 'form') {
                  ...
                  <form (submit)="processPayment($event)" class="space-y-6">
                    ...
                    <button *ngIf="paymentMode === 'online'" type="submit" class="w-full bg-[#800000] text-white font-bold py-4 rounded-xl shadow-lg hover:bg-red-900 transform hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3">
