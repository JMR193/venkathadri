    ...
    <div class="min-h-screen bg-stone-50 overflow-x-hidden">
        ...
        <div class="relative z-10 text-center px-4 max-w-5xl mx-auto mt-16">
          <div class="animate-fade-in-up">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
              <a routerLink="/darshan" class="group relative bg-[#800000] text-white px-10 py-4 rounded-full font-bold transition-all transform hover:scale-105 shadow-2xl border border-red-800 flex items-center justify-center gap-3 overflow-hidden">
      ...
      <section class="py-12 bg-white text-center relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <h2 class="text-4xl md:text-5xl font-serif font-bold text-[#800000] mb-6 leading-tight">A Legacy of Devotion</h2>
